...
(function($) {
 ...
 var dlabChartlist = function(){
	...
	var activityBar1 = function(){
		...
		if (activity1 !== null) {
			var activity1Data = [{
					first: [35, 18, 15, 35, 77, 20, 30, 25, 22, 20, 45, 35, 35]
				},
				{
					first: [50, 35, 10, 45, 77, 50, 60, 35, 10, 50, 34, 35, 50]
				},
				{
					first: [20, 35, 60, 45, 77, 35, 30, 35, 10, 40, 60, 20, 20]
				},
				{
					first: [25, 88, 25, 50, 77, 42, 60, 33, 50, 60, 50, 20, 25]
				}
			];
					...
					datasets: [
						{
							...
							data:  [3, 18, 15, 35, 40, 20, 30, 25, 22, 20, 45, 35, 35],
						...
						},
						{
							...
							data:  [66, 8, 25, 25, 50, 10, 40, 15, 32, 10, 55, 25, 45],
							borderColor: 'black',
							borderWidth: "0",
							barThickness:'18',
							backgroundColor: 'rgb(0, 59, 251)',
							minBarLength: 10,
						},
						{
						...
						{
							label: "My third dataset",
							data:  [44, 36, 10, 39, 49, 24, 50, 95, 82, 20, 45, 35, 45],
							borderColor: 'black',
							borderWidth: "0",
							barThickness:'18',
							backgroundColor: 'rgb(104, 227, 101)',
							minBarLength: 10,
						}
